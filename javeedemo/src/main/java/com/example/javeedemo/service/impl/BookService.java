...
public class BookService implements IBookService {
    ...
    @Override
    public PageInfo<Book> page2(BaseRequest baseRequest) {
        PageHelper.startPage(baseRequest.getPageNum(), baseRequest.getPageSize());
        return new PageInfo<>(bookMapper.listByCondition2(baseRequest));
    }
    ...
    public void updateUpload(Integer id) {
        bookMapper.updateUpload(id);
    }

    @Override
    public void updateUpload1(Integer id) {
        bookMapper.updateUpload1(id);
    }
    ...
    @Override
    public void save2(Book obj) {
        try {
            obj.setCategory(category(obj.getCategories()));
            bookMapper.save2(obj);
        } catch (Exception e) {
            throw new ServiceException("数据插入错误");
        }
    }
    ...
    public void update3(String statement, Integer id) {
        bookMapper.update3(statement,id);
    }
}
