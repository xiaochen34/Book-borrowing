<template>
    <div style="height: 100vh;overflow:auto">
        ...
        <div style="margin:30px;text-align:center;font-size:30px;font-weight:bold;color:dodgerblue">管理员登录</div>
    ...
    methods:{
        login(){
            this.$refs['loginForm'].validate((valid) => {
                if(valid){
                                 request.post('http://localhost:9000/admin/login',this.admin).then(res=>{
                 if (res.code === '200') {
