<template>
    <div style="height: 100vh;overflow:auto">
        ...
        <div style="margin:30px;text-align:center;font-size:30px;font-weight:bold;color:dodgerblue">用户登录</div>
        ...
        <el-input placeholder="请输入密码" prefix-icon="el-icon-lock" size="medium" v-model="admin.password"></el-input>
            ...
            <el-button style="width:100%" size="medium" type="primary" @click="login">登录</el-button>
                    ...
                    <el-form-item>
            <el-button style="width:100%" size="medium" type="primary" @click="login2">注册</el-button>
        </el-form-item>
        </el-form>
        </div>
    ...
    methods:{
        login(){
            this.$refs['loginForm'].validate((valid) => {
                if(valid){
                                 request.post('http://localhost:9000/admin/login1',this.admin).then(res=>{
                 if (res.code === '200') {
